                ...
                <div class="login-signin">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="form">
                        ...
                        <div class="form-group align-items-center">
                            <a href="{{ route('password.request') }}" class="text-muted text-hover-primary text-center">Forget Password ?</a>
                        </div>
                    ...
                    <div class="mt-10">
                        ...
                        <a href="javascript:;"  class="text-muted text-hover-primary font-weight-bold">Register</a>
                    </div>
                </div> 
