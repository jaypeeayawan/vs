...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                            ...
                            <table class="table table-head-custom table-vertical-center" id="">
                                ...
                                <tbody>
                                    @foreach ($voters as $voter)
                                        <tr>
                                            <td><span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $voter->votersnumber }}</span></td>
                                            <td><span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $voter->lastname }}</span></td>
                                            <td><span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $voter->middlename }}</span></td>
                                            <td><span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $voter->firstname }}</span></td>
                                            <td>
                                                <a href="#" id="{{ $voter->id }}" class="update-record" wire:click="fetch({{ $voter->id }})" data-toggle="modal" data-target="#update-record-modal">
                                                    <i class="fas fa-edit text-primary"></i>
                                                </a>
                                                <a href="#" class="delete-record" wire:click="fetch({{ $voter->id }})" data-toggle="modal" data-target="#delete-record-modal">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="newRecord">Add Voter</h5>
                </div>
    ...
    <div wire:ignore.self class="modal fade" id="update-record-modal" tabindex="-1" role="dialog" aria-labelledby="udpateRecord" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="udpateRecord">Update Voter</h5>
                </div>
                <div class="modal-body">
    ...
    <div wire:ignore.self class="modal fade" id="delete-record-modal" tabindex="-1" role="dialog" aria-labelledby="deleteRecord" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteRecord">Delete Voter</h5>
                </div>
                <div class="modal-body">
